...
from seqr.views.apis.report_api_tests import (
    PARTICIPANT_TABLE,
    PHENOTYPE_TABLE,
    EXPERIMENT_TABLE,
...
PM_REQUIRED_INDIVIDUAL_UPDATE_DATA = {
    "individualGuid": PM_REQUIRED_INDIVIDUAL_GUID,
    "individualId": "NA20889",
    "familyId": "12",
    "displayName": "NA20889_a",
}
...
class IndividualAPITest(object):
    ...
    def test_update_individual_handler(self):
        edit_individuals_url = reverse(
            update_individual_handler, args=[INDIVIDUAL_UPDATE_GUID]
        )
        self.check_collaborator_login(edit_individuals_url)

        response = self.client.post(
            edit_individuals_url,
        ...
        self.assertSetEqual(
            set(response_json[INDIVIDUAL_UPDATE_GUID].keys()), INDIVIDUAL_CORE_FIELDS
        )
        individual = Individual.objects.get(guid=INDIVIDUAL_UPDATE_GUID)
        self.assertEqual(
            response_json[INDIVIDUAL_UPDATE_GUID]["displayName"], "NA20870"
        )
        ...
        self.assertSetEqual(
            set(response_json[INDIVIDUAL_UPDATE_GUID].keys()), response_fields
        )
    ...
    def test_update_individual_hpo_terms(self):
        edit_individuals_url = reverse(
            update_individual_hpo_terms, args=[INDIVIDUAL_UPDATE_GUID]
        )
    ...
    def test_edit_individuals(self, mock_pm_group):
        ...
        response = self.client.post(
            edit_individuals_url, content_type="application/json", data=json.dumps({})
        )
        ...
        response = self.client.post(
            edit_individuals_url,
            content_type="application/json",
            data=json.dumps({"individuals": [INDIVIDUAL_IDS_UPDATE_DATA]}),
        )
        self.assertEqual(response.status_code, 400)
        self.assertListEqual(
        ...
        # send valid request
        Sample.objects.filter(guid__in=["S000130_na19678", "S000135_na20870"]).update(
            is_active=False
        )
        response = self.client.post(
            edit_individuals_url,
        ...
        self.assertSetEqual(
            {"F000001_1", "F000003_3"}, set(response_json["familiesByGuid"])
        )
        self.assertSetEqual(
            {ID_UPDATE_GUID, FAMILY_UPDATE_GUID, INDIVIDUAL_GUID, "I000003_na19679"},
            set(response_json["familiesByGuid"]["F000001_1"]["individualGuids"]),
        )
        self.assertListEqual(
            response_json["familiesByGuid"]["F000003_3"]["individualGuids"], []
        )
        ...
        self.assertSetEqual(
            {ID_UPDATE_GUID, FAMILY_UPDATE_GUID, INDIVIDUAL_GUID},
            set(response_json["individualsByGuid"]),
        )
        self.assertEqual(
            response_json["individualsByGuid"][ID_UPDATE_GUID]["individualId"],
            UPDATED_ID,
        )
        self.assertEqual(
            response_json["individualsByGuid"][ID_UPDATE_GUID]["maternalId"],
            UPDATED_MATERNAL_ID,
        )
        self.assertEqual(
            response_json["individualsByGuid"][INDIVIDUAL_GUID]["paternalId"],
            UPDATED_ID,
        )
        ...
        self.assertEqual(
            response_json["individualsByGuid"][ID_UPDATE_GUID]["maternalId"], "NA19679"
        )

        # Test PM permission
        pm_required_edit_individuals_url = reverse(
            edit_individuals_handler, args=[PM_REQUIRED_PROJECT_GUID]
        )
        response = self.client.post(
            pm_required_edit_individuals_url,
            content_type="application/json",
            data=json.dumps({"individuals": [PM_REQUIRED_INDIVIDUAL_UPDATE_DATA]}),
        )
        self.assertEqual(response.status_code, 403)
        ...
        ext_anvil_edit_individuals_url = reverse(
            edit_individuals_handler, args=[EXTERNAL_WORKSPACE_PROJECT_GUID]
        )
        self.login_collaborator()
        response = self.client.post(
            ext_anvil_edit_individuals_url,
            content_type="application/json",
            data=json.dumps(
        ...
        response = self.client.post(
            ext_anvil_edit_individuals_url,
            content_type="application/json",
            data=json.dumps({"individuals": [update_json]}),
        )
        ...
        updated_individual = response_json["individualsByGuid"][
            EXTERNAL_WORKSPACE_INDIVIDUAL_GUID
        ]
    ...
    def test_delete_individuals(self, mock_pm_group):
        ...
        response = self.client.post(
            individuals_url,
            content_type="application/json",
            data=json.dumps({"individualsX": [INDIVIDUAL_IDS_UPDATE_DATA]}),
        )
        self.assertEqual(response.status_code, 400)
    ...
    def _assert_expected_delete_individuals(self, response, mock_pm_group):
        ...
        self.assertFalse(
            "I000002_na19678"
            in response_json["familiesByGuid"]["F000001_1"]["individualGuids"]
        )
        self.assertIsNone(response_json["familiesByGuid"]["F000001_1"]["pedigreeImage"])

        # Test PM permission
        pm_required_delete_individuals_url = reverse(
            delete_individuals_handler, args=[PM_REQUIRED_PROJECT_GUID]
        )
        response = self.client.post(
            pm_required_delete_individuals_url,
            content_type="application/json",
            data=json.dumps({"individuals": [PM_REQUIRED_INDIVIDUAL_UPDATE_DATA]}),
        )
        self.assertEqual(response.status_code, 403)
        ...
        self.assertListEqual(
            response.json()["errors"],
            ["Unable to delete individuals with active MME submission: NA20889"],
        )

        data = json.dumps({"individuals": [{"individualGuid": "I000015_na20885"}]})
        response = self.client.post(
            pm_required_delete_individuals_url,
            content_type="application/json",
            data=data,
        ...
        # Test External AnVIL projects
        ext_anvil_delete_individuals_url = reverse(
            delete_individuals_handler, args=[EXTERNAL_WORKSPACE_PROJECT_GUID]
        )
        self.login_collaborator()
        response = self.client.post(
            ext_anvil_delete_individuals_url,
            content_type="application/json",
            data=json.dumps(
                {"individuals": [EXTERNAL_WORKSPACE_INDIVIDUAL_UPDATE_DATA]}
            ),
        ...
        self.assertEqual(
            response.status_code, 200 if self.HAS_EXTERNAL_PROJECT_ACCESS else 403
        )
    ...
    def test_individuals_table_handler_errors(self):
        ...
        self.assertDictEqual(
            response.json(),
            {"errors": ["Received 0 files instead of 1"], "warnings": []},
        )
        ...
        self.assertDictEqual(
            response.json(),
            {
                "warnings": None,
                "errors": [
                    "Missing Family Id in row #1",
                    "Missing Individual Id in row #1",
                ],
            },
        )
        ...
        self.assertDictEqual(
            ...
            {
                "errors": [
                    "Could not find individuals with the following previous IDs: NA19675"
                ],
                "warnings": [],
            },
        )
        ...
        response = self.client.post(
            individuals_url,
            {
                "f": SimpleUploadedFile(
                    "test.tsv",
                    'Family ID	Individual ID	affected	sex	proband_relation\n"1"	"NA19675_1"	"no"	"boy"	"mom"'.encode(
                        "utf-8"
                    ),
                )
            },
...
"21"	" HG00735"	""	""	""	"Female"	"Affected"	""	"a new family""'
        ...
        f = SimpleUploadedFile(
            "1000_genomes demo_individuals.tsv", data.encode("utf-8")
        )
        ...
        self.assertSetEqual(
            ...
            {"individualsByGuid", "familiesByGuid", "familyNotesByGuid"},
        )
        ...
        new_family_guid = next(
            guid
            for guid in response_json["familiesByGuid"].keys()
        ...
        # Test PM permission
        receive_url = reverse(
            receive_individuals_table_handler, args=[PM_REQUIRED_PROJECT_GUID]
        )
        save_url = reverse(
            save_individuals_table_handler, args=[PM_REQUIRED_PROJECT_GUID, "123"]
        )
        ...
        save_url = reverse(
            save_individuals_table_handler,
            args=[PM_REQUIRED_PROJECT_GUID, response.json()["uploadedFileId"]],
        )
        response = self.client.post(save_url)
        self.assertEqual(response.status_code, 200)
    ...
    @mock.patch("seqr.views.utils.permissions_utils.PM_USER_GROUP", "project-managers")
    @mock.patch(
        "seqr.views.utils.pedigree_info_utils.NO_VALIDATE_MANIFEST_PROJECT_CATEGORIES"
    )
    @mock.patch("seqr.utils.communication_utils.EmailMultiAlternatives")
    def test_individuals_sample_manifest_table_handler(
        self, mock_email, mock_no_validate_categories
    ):
        ...
        data += [
            ...
            [
                ...
                "PED073",
                "SCO_PED073C_GA0340",
                "SCO_PED073C_GA0340_1",
                "SCO_PED073B_GA0339_1",
                "SCO_PED073A_GA0338_1",
                "female",
                "affected",
        ...
        self.assertDictEqual(
            response.json(),
            {
                "warnings": None,
                "errors": [
                    'Invalid value "Maybe" for Tissue Affected Status in row #1'
                ],
            },
        )
        ...
        self.assertEqual(response.status_code, 400)
        self.assertDictEqual(
            response.json(), {"warnings": [], "errors": [expected_warning]}
        )
    ...
    """.replace(
        ...
        self.assertListEqual(
            [[cell.value or "" for cell in row] for row in original_ws],
            [[str(c) for c in row] for row in data],
        )
        ...
        self.assertEqual(
            response_json["familiesByGuid"][family_guid]["familyId"], "PED073"
        )
        self.assertEqual(
            response_json["familiesByGuid"][family_guid]["codedPhenotype"],
            "Perinatal death",
        )
        self.assertEqual(
            response_json["familiesByGuid"][family_guid]["mondoId"], "MONDO:0100086"
        )
        self.assertSetEqual(
            set(response_json["familiesByGuid"][family_guid]["individualGuids"]),
            set(response_json["individualsByGuid"].keys()),
        )
        self.assertSetEqual(
            {i["familyGuid"] for i in response_json["individualsByGuid"].values()},
            {family_guid},
        )
        ...
        indiv_1 = next(
            i
            for i in response_json["individualsByGuid"].values()
            if i["individualId"] == "SCO_PED073B_GA0339_1"
        )
        self.assertDictEqual(
            {k: v for k, v in indiv_1.items() if k in test_keys},
            {
                "affected": "N",
                "notes": "probably dad",
                "sex": "M",
        ...
        indiv_2 = next(
            i
            for i in response_json["individualsByGuid"].values()
            if i["individualId"] == "SCO_PED073C_GA0341_1"
        )
        self.assertDictEqual(
            {k: v for k, v in indiv_2.items() if k in test_keys},
            {
                "affected": "A",
                "notes": "half sib",
                "sex": "M",
        ...
        indiv_3 = next(
            i
            for i in response_json["individualsByGuid"].values()
            if i["individualId"] == "SCO_PED073C_GA0340_1"
        )
        self.assertDictEqual(
            {k: v for k, v in indiv_3.items() if k in test_keys},
            {
                "affected": "A",
                "notes": None,
                "sex": "F",
    ...
    def test_individuals_datastat_table_handler(self, mock_date):
        ...
        data = [
            [
                ...
                "DESCRIPTION",
                "CLINICAL_DIAGNOSES",
                "CLINICAL_DIAGNOSES_DETAILS",
                "GENETIC_DIAGNOSES",
                "GENETIC_DIAGNOSES_DETAILS",
                "FIND_OUT_DOCTOR_DETAILS",
                "PATIENT_AGE",
                "CONDITION_AGE",
                "PATIENT_DECEASED",
                "DECEASED_AGE",
                ...
                "ETHNICITY",
                "DOCTOR_TYPES",
                "DOCTOR_TYPES_OTHER_DETAILS",
                "TESTS",
                "TESTS_MICROARRAY_YEAR",
                "TESTS_MICROARRAY_LAB",
                "TESTS_MICROARRAY_FAMILY",
                "TESTS_MICROARRAY_FAMILY_OTHER_DETAILS",
                "TESTS_WEXOME_YEAR",
                "TESTS_WEXOME_LAB",
                "TESTS_WEXOME_FAMILY",
                "TESTS_WEXOME_FAMILY_OTHER_DETAILS",
                "TESTS_WGENOME_YEAR",
                "TESTS_WGENOME_LAB",
                "TESTS_WGENOME_FAMILY",
                "TESTS_WGENOME_FAMILY_OTHER_DETAILS",
                "TESTS_OTHER_DETAILS",
                "BIOPSY",
                "BIOPSY_OTHER_DETAILS",
                "OTHER_STUDIES",
                "OTHER_STUDIES_DESCRIBE",
                "EXPECT_RESULTS",
                "MOTHER_SAME_CONDITION",
                "MOTHER_CONDITION_AGE",
                "MOTHER_RACE",
                "MOTHER_ETHNICITY",
                "MOTHER_CAN_PARTICIPATE",
                "MOTHER_DECEASED",
                "MOTHER_DECEASED_DNA",
                "FATHER_SAME_CONDITION",
                "FATHER_CONDITION_AGE",
                "FATHER_RACE",
                "FATHER_ETHNICITY",
                "FATHER_CAN_PARTICIPATE",
                "FATHER_DECEASED",
                "FATHER_DECEASED_DNA",
                "NO_SIBLINGS",
                "SIBLING",
            ...
            [
                ...
                "WHITE,ASIAN,PACIFIC",
                "NOT_HISPANIC",
                "CLIN_GEN,NEURO,CARDIO,OTHER",
                "Pediatrician",
                "SINGLE_GENE,GENE_PANEL,WEXOME,WGENOME,OTHER",
                "",
                "",
                "",
                "",
                "2018",
                "UDN\xe2s lab",
                "PARENT,AUNT_UNCLE,NIECE_NEPHEW,OTHER",
                "Grandmother",
                "",
                "",
                "",
                ...
                "NO",
                "",
                '[{"SIBLING_SEX":"FEMALE","SIBLING_AGE":"21","SIBLING_RACE":"WHITE","SIBLING_ETHNICITY":"NOT_HISPANIC","SIBLING_SAME_CONDITION":"YES","SIBLING_CONDITION_AGE":null,"SIBLING_CAN_PARTICIPATE":"NO"},{"SIBLING_SEX":"","SIBLING_AGE":"17","SIBLING_RACE": "WHITE","SIBLING_ETHNICITY":"NOT_HISPANIC","SIBLING_SAME_CONDITION":"","SIBLING_CONDITION_AGE":"","SIBLING_CAN_PARTICIPATE":"YES"}]',
                "YES",
                "",
                "NO",
                '[{"RELATIVE_SEX":"MALE","RELATIVE_AGE":"44","RELATIVE_RACE": "WHITE", "RELATIVE_ETHNICITY":"NOT_HISPANIC","RELATIVE_CONDITION_AGE":null,"RELATIVE_CAN_PARTICIPATE":null}]',
            ...
            [
                ...
                "YES",
                "YES",
                '[{"SIBLING_SEX":"FEMALE","SIBLING_AGE":"21","SIBLING_RACE":"WHITE","SIBLING_ETHNICITY":"NOT_HISPANIC","SIBLING_SAME_CONDITION":"YES","SIBLING_CONDITION_AGE":null,"SIBLING_CAN_PARTICIPATE":"NO"}]',
                "NO",
                '[{"CHILD_SEX":"MALE","CHILD_AGE":"12","CHILD_RACE":"WHITE","CHILD_ETHNICITY":"NOT_HISPANIC","CHILD_SAME_CONDITION":"NO","CHILD_CONDITION_AGE":null,"CHILD_CAN_PARTICIPATE":"UNSURE"}]',
                "YES",
                "",
                "",
            ],
        ...
        RGP_123_guid = next(
            f
            for f in response_json["familiesByGuid"].values()
            if f["familyId"] == "RGP_123"
        )["familyGuid"]
        RGP_987_guid = next(
            f
            for f in response_json["familiesByGuid"].values()
            if f["familyId"] == "RGP_987"
        )["familyGuid"]
        self.assertEqual(len(response_json["individualsByGuid"]), 6)
        individuals = sorted(
            response_json["individualsByGuid"].values(), key=lambda i: i["individualId"]
        )
        self.assertListEqual(
        ...
        self.assertListEqual(
            [i["sex"] for i in individuals], ["F", "M", "M", "F", "M", "U"]
        )
        self.assertListEqual(
            [i["affected"] for i in individuals], ["N", "N", "A", "N", "N", "A"]
        )
        ...
        self.assertDictEqual(
            {k: v for k, v in individuals[2].items() if k in no_parent_fields},
            {
                "maternalGuid": individuals[0]["individualGuid"],
                "paternalGuid": individuals[1]["individualGuid"],
                "maternalId": "RGP_123_1",
                "paternalId": "RGP_123_2",
                "paternalEthnicity": ["Black"],
                "maternalEthnicity": ["White", "Asian", "Not Hispanic"],
                "birthYear": 1986,
                "deathYear": 2019,
                "onsetAge": "A",
                "affectedRelatives": True,
            },
        )
        self.assertDictEqual(
            {k: v for k, v in individuals[5].items() if k in no_parent_fields},
            {
                "maternalGuid": individuals[3]["individualGuid"],
                "paternalGuid": individuals[4]["individualGuid"],
                "maternalId": "RGP_987_1",
                "paternalId": "RGP_987_2",
                "maternalEthnicity": None,
                "paternalEthnicity": None,
                "birthYear": 1973,
                "deathYear": None,
                "onsetAge": "C",
        ...
        note_1 = next(
            n["note"]
            for n in response_json["familyNotesByGuid"].values()
            if n["familyGuid"] == RGP_123_guid
        )
        self.assertEqual(
            note_1,
...
* __Relatives:__ None""",
    ...
    def _is_expected_individuals_metadata_upload(
        self, response, expected_families=False, has_non_hpo_update=False
    ):
        ...
        if expected_families:
            expected_response["warnings"].insert(
                1,
                'The following invalid values for "assigned_analyst" will not be added: test_user_no_access@test.com (NA19679)',
            )
        ...
        self.assertSetEqual(
            set(response_json["individualsByGuid"].keys()), updated_individuals
        )
        self.assertSetEqual(
            set(response_json["individualsByGuid"]["I000001_na19675"].keys()),
            INDIVIDUAL_FIELDS,
        )
        self.assertListEqual(
        ...
        self.assertEqual(
            response_json["individualsByGuid"]["I000001_na19675"]["sex"], "XXY"
        )
        self.assertEqual(
            response_json["individualsByGuid"]["I000001_na19675"]["birthYear"], 2000
        )
        self.assertTrue(
            response_json["individualsByGuid"]["I000001_na19675"]["affectedRelatives"]
        )
        self.assertEqual(
            response_json["individualsByGuid"]["I000001_na19675"]["onsetAge"], "J"
        )
        self.assertListEqual(
            response_json["individualsByGuid"]["I000001_na19675"][
                "expectedInheritance"
            ],
            ["D", "S"],
        )
        self.assertListEqual(
            response_json["individualsByGuid"]["I000001_na19675"]["maternalEthnicity"],
            ["Finnish", "Irish"],
        )
        self.assertListEqual(
            response_json["individualsByGuid"]["I000001_na19675"]["candidateGenes"],
            [
                {"gene": "IKBKAP", "comments": "multiple panels, no confirm"},
                {"gene": "EHBP1L1"},
            ],
        )
        ...
        if has_non_hpo_update:
            self.assertIsNone(
                response_json["individualsByGuid"]["I000002_na19678"]["features"]
            )
            self.assertFalse(
                response_json["individualsByGuid"]["I000002_na19678"][
                    "affectedRelatives"
                ]
            )
        ...
        if expected_families:
            self.assertListEqual(
                list(response_json["familiesByGuid"].keys()), ["F000001_1"]
            )
            self.assertDictEqual(
                response_json["familiesByGuid"]["F000001_1"]["assignedAnalyst"],
                {
                    "email": "test_user_collaborator@test.com",
                    "fullName": "Test Collaborator User",
                },
            )
    ...
    def test_individuals_metadata_table_handler(self):
        ...
        rows.append(
            '1,NA19675_1,HP:0002017,"HP:0012469 (Infantile spasms);HP:0004322 (Short stature, severe)",F,2000,True,Juvenile onset,"Autosomal dominant inheritance, Sporadic","Finnish, Irish","IKBKAP -- (multiple panels, no confirm), EHBP1L1",test_user_collaborator@test.com'
        )
        f = SimpleUploadedFile(
            "updates.csv", "{}\n{}".format(header, "\n".join(rows)).encode("utf-8")
        )
        response = self.client.post(url, data={"f": f})
        self._is_expected_individuals_metadata_upload(
            response, expected_families=True, has_non_hpo_update=True
        )
    ...
    def _set_metadata_file_iter(self, mock_subprocess, genetic_findings_table):
        mock_subprocess.return_value.stdout.__iter__.side_effect = [
            iter(["\t".join(row).encode() for row in file])
            for file in [
                EXPERIMENT_TABLE,
                EXPERIMENT_LOOKUP_TABLE,
    ...
    def test_import_gregor_metadata(self, mock_subprocess):
        ...
        genetic_findings_table[2] = (
            genetic_findings_table[2][:11]
            + genetic_findings_table[4][11:14]
            + genetic_findings_table[2][14:]
        )
        genetic_findings_table.append(
            [
                "Broad_NA20889_1_249045487",
                "Broad_NA20889",
                "",
                "SNV/INDEL",
                "GRCh37",
        ...
        body = {
            ...
            "workspaceName": "anvil-1kg project nåme with uniçøde",
            "sampleType": "exome",
        }
        response = self.client.post(
        ...
        existing_variant_tags = variant_tags.filter(
            saved_variants__guid="SV0000006_1248367227_r0003_tes"
        )
        new_variant_tags = variant_tags.filter(
            saved_variants__guid=saved_variants[1]["guid"]
        )
        ...
        new_family_tag = variant_tags.get(
            saved_variants__guid=saved_variants[2]["guid"]
        )
        self.assertDictEqual(
            json.loads(new_family_tag.metadata),
            {"gene_known_for_phenotype": "Known", "condition_id": "MONDO:0044970"},
        )

        mock_subprocess.assert_has_calls(
            [
                mock.call(
                    "gsutil cat gs://test_bucket/data_tables/experiment_dna_short_read.tsv",
                    stdout=-1,
                    stderr=-2,
                    shell=True,
                ),  # nosec
                ...
                mock.call(
                    "gsutil cat gs://test_bucket/data_tables/experiment.tsv",
                    stdout=-1,
                    stderr=-2,
                    shell=True,
                ),  # nosec
                mock.call().stdout.__iter__(),
                mock.call(
                    "gsutil cat gs://test_bucket/data_tables/participant.tsv",
                    stdout=-1,
                    stderr=-2,
                    shell=True,
                ),  # nosec
                mock.call().stdout.__iter__(),
                mock.call(
                    "gsutil cat gs://test_bucket/data_tables/phenotype.tsv",
                    stdout=-1,
                    stderr=-2,
                    shell=True,
                ),  # nosec
                mock.call().stdout.__iter__(),
                mock.call(
                    "gsutil cat gs://test_bucket/data_tables/genetic_findings.tsv",
                    stdout=-1,
                    stderr=-2,
                    shell=True,
                ),  # nosec
    ...
    def test_get_individual_rna_seq_data(self):
                        ...
                        "ENSG00000268903": [
                            {
                                ...
                                "zScore": 7.08,
                                "pValue": 0.000000000588,
                                "pAdjust": 0.00000000139,
                                "isSignificant": True,
                                "tissueType": "M",
                            }
                        ],
        ...
        outliers_by_pos = {
            outlier["start"]: outlier
            for outlier in response_json["rnaSeqData"][INDIVIDUAL_GUID][
                "spliceOutliers"
            ]["ENSG00000268903"]
        }
        self.assertDictEqual(
            {
                ...
                "isSignificant": True,
                "meanCounts": 0.85,
                "meanTotalCounts": 0.85,
                "pAdjust": 3.08e-56,
                "pValue": 1.08e-56,
                "rareDiseaseSamplesTotal": 20,
                "rareDiseaseSamplesWithThisJunction": 1,
                "totalCounts": 1297,
                "start": 132885746,
                "strand": "*",
                "type": "psi5",
                "deltaIntronJaccardIndex": 12.34,
                "tissueType": "F",
            },
        ...
        self.assertSetEqual(
            ...
            {"ENSG00000135953", "ENSG00000268903"},
        )
        self.assertSetEqual(
            set(response_json["genesById"]["ENSG00000135953"].keys()), GENE_FIELDS
        )
    ...
    def test_get_individual_rna_seq_data_is_significant(self):
        ...
        self.assertTrue(
            response_rnaseq_data["outliers"]["ENSG00000135953"][0]["isSignificant"]
        )
        significant_outliers = [
            outlier
            for outlier in response_rnaseq_data["outliers"].values()
            if outlier[0]["isSignificant"]
        ]
        ...
        self.assertListEqual(
            sorted(
                [
                    ...
                    for outlier in response_rnaseq_data["spliceOutliers"][
                        "ENSG00000268903"
                    ]
                ],
...
class AnvilIndividualAPITest(AnvilAuthenticationTestCase, IndividualAPITest):
    ...
    def _mock_subprocess(self, command, **kwargs):
        command_args = re.match(
            r"gsutil (?P<cmd>cat|mv)(?P<local_path> \S+)? gs://seqr-scratch-temp/(?P<gs_path>\S+)",
            command,
        ).groupdict()
    ...
    def _assert_expected_delete_individuals(self, response, mock_pm_group):
        ...
        self.assertListEqual(
            response.json()["errors"],
            ["Unable to delete individuals with active search sample: NA19678"],
        )
