...
from seqr.views.apis.data_manager_api import (
    ...
    load_phenotype_prioritization_data,
    validate_callset,
    loading_vcfs,
    get_loaded_projects,
    trigger_dag,
...
SAMPLE_GENE_SPLICE_DATA = [
    {
        ...
        "p_value": "1.56e-25",
        "p_adjust": "-4.9",
        "delta_intron_jaccard_index": "-0.46",
        "counts": "166",
        "mean_counts": "16.6",
        "total_counts": "1660",
        "mean_total_counts": "1.66",
        "rare_disease_samples_with_this_junction": "1",
    ...
    },
    {
        ...
        "p_value": "1.08e-56",
        "p_adjust": "-6.53",
        "delta_intron_jaccard_index": "-0.85",
        "counts": "231",
        "mean_counts": "0.231",
        "total_counts": "2313",
        "mean_total_counts": "231.3",
        "rare_disease_samples_with_this_junction": "1",
        "rare_disease_samples_total": "20",
        "gene_id": "ENSG00000240361",
    },
...
SAMPLE_GENE_SPLICE_DATA2 = {
    ...
    "p_value": "1.56e-25",
    "p_adjust": "6.33",
    "delta_intron_jaccard_index": "0.45",
    "counts": "143",
    "mean_counts": "14.3",
    "total_counts": "1433",
    "mean_total_counts": "143.3",
    "rare_disease_samples_with_this_junction": "1",
    "rare_disease_samples_total": "20",
    "gene_id": "",
}
RNA_OUTLIER_SAMPLE_DATA = {
    RNA_OUTLIER_MUSCLE_SAMPLE_GUID: "\n".join(
        [json.dumps(row) for row in SAMPLE_GENE_OUTLIER_DATA]
    )
    + "\n",
    PLACEHOLDER_GUID: json.dumps(
        {
            "gene_id": "ENSG00000240361",
            "p_value": "0.04",
            "p_adjust": "0.112",
...
RNA_TPM_SAMPLE_DATA = {
    RNA_TPM_MUSCLE_SAMPLE_GUID: "\n".join(
        [json.dumps(row) for row in SAMPLE_GENE_TPM_DATA]
    )
    + "\n",
...
RNA_SPLICE_SAMPLE_DATA = {
    RNA_SPLICE_SAMPLE_GUID: "\n".join(
        [json.dumps(row) for row in SAMPLE_GENE_SPLICE_DATA]
    )
    + "\n",
...
PHENOTYPE_PRIORITIZATION_HEADER = [
    [
        "tool",
        "project",
        "sampleId",
...
PHENOTYPE_PRIORITIZATION_MISS_HEADER = [
    [
        "tool",
        "sampleId",
        "rank",
...
EXPECTED_LIRICAL_DATA = [
    {
        "diseaseId": "OMIM:219801",
        "geneId": "ENSG00000268904",
        "diseaseName": "Cystinosis, no syndrome",
        "scores": {"compositeLR": 0.003, "post_test_probability": 0.1},
        "tool": "lirical",
        "rank": 11,
        "individualGuid": "I000001_na19675",
    },  # record from the fixture
    {
        "diseaseId": "OMIM:618460",
        "geneId": "ENSG00000105357",
        "diseaseName": "Khan-Khan-Katsanis syndrome",
        "scores": {"compositeLR": 0.066, "postTestProbability": 0.0},
        "tool": "lirical",
        "rank": 1,
        "individualGuid": "I000002_na19678",
    },
    {
        "diseaseId": "OMIM:219800",
        "geneId": "ENSG00000105357",
        "diseaseName": "Cystinosis, nephropathic",
    ...
    "records": [
        {
            ...
            "fields": {
                "SeqrProject": [
                    "https://seqr.genomics4rd.ca/project/R0002_empty/project_page"
                ],
        ...
        },
        {
            ...
            "fields": {
                "SeqrProject": [
                    "https://seqr.genomics4rd.ca/project/R0002_empty/project_page",
                    "https://seqr.genomics4rd.ca/project/R0004_non_analyst_project/project_page",
                ],
        ...
        },
        {
            ...
            "fields": {
                ...
                "SeqrProject": [
                    "https://seqr.genomics4rd.ca/project/R0001_1kg/project_page"
                ],
    ...
    "records": [
        ...
        },
        {
            ...
            "fields": {
                "CollaboratorSampleID": "HG00731",
                "SeqrProject": [
                    "https://seqr.genomics4rd.ca/project/R0001_1kg/details"
                ],
                "PDOStatus": ["Available in seqr"],
            },
        },
...
class DataManagerAPITest(AirtableTest):
    ...
    def _assert_expected_es_status(self, response):
        ...
        self.assertSetEqual(
            set(response_json.keys()), {"indices", "errors", "diskStats", "nodeStats"}
        )
    ...
    def test_delete_index(self):
        ...
        self.assertEqual(
            response.json()["error"],
            '"test_index" is still used by: 1kg project n\xe5me with uni\xe7\xf8de',
        )
    ...
    def test_kibana_proxy(self):
        ...
        self._test_request_proxy(
            "localhost:5601", url, auth_header="Basic a2liYW5hOmFiYzEyMw=="
        )
    ...
    def test_luigi_proxy(self, mock_hostname):
        ...
        self.assertEqual(response.status_code, 400)
        self.assertContains(
            response, "Error: Unable to connect to Luigi UI", status_code=400
        )

        responses.calls.reset()
        self._test_request_proxy(
            "pipeline-runner-ui:8082", url, proxy_path="/api/task_list"
        )
    ...
    RNA_DATA_TYPE_PARAMS = {
        "outlier": {
            ...
            "get_models_json": lambda models: list(
                models.values_list("gene_id", "p_adjust", "p_value", "z_score")
            ),
            "expected_models_json": [
                ("ENSG00000240361", 0.13, 0.01, -3.1),
                ("ENSG00000233750", 0.0000057, 0.064, 7.8),
            ],
        ...
        "tpm": {
            ...
            "get_models_json": lambda models: list(
                models.values_list("gene_id", "tpm")
            ),
            "expected_models_json": [
                ("ENSG00000240361", 7.8),
                ("ENSG00000233750", 0.0),
        ...
        "splice_outlier": {
            ...
            "new_data": [
                ...
                [
                    "NA19675_1",
                    "1kg project nåme with uniçøde",
                    "ENSG00000233750;ENSG00000240361",
                    "chr2",
                    167254166,
                    167258349,
                    "*",
            ...
            "get_models_json": lambda models: list(
                models.values_list(
                    ...
                    "counts",
                    "rare_disease_samples_with_this_junction",
    ...
    def _has_expected_file_loading_logs(
        self,
        file,
        user,
        info=None,
    ...
    def _check_rna_sample_model(
        self, individual_id, data_source, data_type, tissue_type, is_active_sample=True
    ):
    ...
    @mock.patch(
        "seqr.views.utils.dataset_utils.SEQR_SLACK_DATA_ALERTS_NOTIFICATION_CHANNEL",
        "seqr-data-loading",
    )
    ...
    def _test_update_rna_seq(
        self,
        data_type,
        mock_open,
        mock_subprocess,
        mock_load_uploaded_file,
        mock_rename,
        mock_mkdir,
        mock_datetime,
        mock_send_slack,
        ...
        self.assertDictEqual(
            response.json(),
            {"error": "File not found: gs://rna_data/muscle_samples.tsv"},
        )
        ...
        response = self.client.post(
            url, content_type="application/json", data=json.dumps(invalid_body)
        )
        self.assertEqual(response.status_code, 400)
        self.assertDictEqual(
            response.json(),
            {
                "error": "Unexpected iterated file type: gs://rna_data/muscle_samples.xlsx"
            },
        )
        ...
        self.assertDictEqual(
            ...
            {
                "errors": [
                    "Unable to find matches for the following samples: NA19675_D3 (1kg project nåme with uniçøde)"
                ],
                "warnings": None,
            },
        )

        unknown_gene_id_row1 = (
            loaded_data_row[:2] + ["NOT_A_GENE_ID1"] + loaded_data_row[3:]
        )
        unknown_gene_id_row2 = (
            loaded_data_row[:2] + ["NOT_A_GENE_ID2"] + loaded_data_row[3:]
        )
        ...
        self.assertEqual(
            ...
            "Unknown Gene IDs: NOT_A_GENE_ID1, NOT_A_GENE_ID2",
        )

        if not params.get("allow_missing_gene"):
            _set_file_iter_stdout(
                [header, loaded_data_row[:2] + [""] + loaded_data_row[3:]]
            )
            response = self.client.post(
                url, content_type="application/json", data=json.dumps(body)
            )
            ...
            self.assertEqual(
                response.json()["errors"][0],
                'Samples missing required "gene_id": NA19675_D2',
            )
        ...
        self._has_expected_file_loading_logs(
            "gs://rna_data/muscle_samples.tsv.gz",
            info=info,
            warnings=warnings,
            user=self.pm_user,
        )
        ...
        mock_subprocess.assert_has_calls(
            [
                mock.call(command, stdout=-1, stderr=-2, shell=True)
                for command in [  # nosec
        ...
        def _test_basic_data_loading(
            data,
            num_parsed_samples,
            num_loaded_samples,
            new_sample_individual_id,
            body,
            project_names,
            ...
            additional_logs = [
                (
                    f"create {num_created_samples} RnaSamples",
                    {
                        "dbUpdate": {
                            "dbEntity": "RnaSample",
                            "updateType": "bulk_create",
                            "entityIds": (
                                response_json["sampleGuids"]
                                if num_created_samples > 1
                                else [new_sample_guid]
                            ),
                        }
                    },
                )
            ...
            self._has_expected_file_loading_logs(
                "gs://rna_data/new_muscle_samples.tsv.gz",
                info=info,
                warnings=warnings,
                user=self.pm_user,
                additional_logs=additional_logs,
                additional_logs_offset=2,
            )
        ...
        response_json, new_sample_guid = _test_basic_data_loading(
            params["new_data"],
            params["num_parsed_samples"],
            2,
            16,
            body,
            "1kg project nåme with uniçøde, Test Reprocessed Project",
            warnings=warnings,
            ...
            additional_logs=[
                ...
                (
                    f"delete {model_cls.__name__}s",
                    {
                        "dbUpdate": {
                            "dbEntity": model_cls.__name__,
                            "numEntities": deleted_count,
                            "parentEntityIds": [params["sample_guid"]],
        ...
        self._assert_expected_notifications(
            mock_send_email,
            [
                {
                    "data_type": f'RNA {params["message_data_type"]}',
                ...
                },
                {
                    ...
                    "project_name": "Test Reprocessed Project",
                },
            ],
        )
        ...
        self.assertEqual(
            model_cls.objects.count(), params["initial_model_count"] - deleted_count
        )
        sample_guid = self._check_rna_sample_model(
            individual_id=1,
            data_source="new_muscle_samples.tsv.gz",
            data_type=params["data_type"],
            tissue_type=params.get("sample_tissue_type"),
        ...
        self.assertSetEqual(
            set(response_json["sampleGuids"]), {sample_guid, new_sample_guid}
        )
        ...
        mock_subprocess.assert_has_calls(
            [
                mock.call(command, stdout=-1, stderr=-2, shell=True)
                for command in expected_subprocess_calls  # nosec
            ]
        )
        ...
        file_rename = self._assert_expected_file_open(
            mock_rename, mock_open, expected_files.keys()
        )
        ...
        response_json, new_sample_guid = _test_basic_data_loading(
            data, 2, 2, new_sample_individual_id, body, "1kg project nåme with uniçøde"
        )
        ...
        self._assert_expected_file_open(
            mock_rename,
            mock_open,
            [
    ...
    def _assert_expected_file_open(self, mock_rename, mock_open, expected_file_names):
        file_rename = {
            call.args[1]: call.args[0] for call in mock_rename.call_args_list
        }
        self.assertSetEqual(set(expected_file_names), set(file_rename.keys()))
        mock_open.assert_has_calls(
            [mock.call(file_rename[filename], "at") for filename in expected_file_names]
        )
        return file_rename
    ...
    def test_load_rna_seq_sample_data(self):
        ...
        for data_type, params in self.RNA_DATA_TYPE_PARAMS.items():
            with self.subTest(data_type):
                ...
                self.reset_logs()
                parsed_file_lines = (
                    params["parsed_file_data"][sample_guid].strip().split("\n")
                )
                ...
                self.assertSetEqual(
                    {model.sample.guid for model in models}, {sample_guid}
                )
                ...
                self.assert_json_logs(
                    ...
                    [
                        ...
                        *subprocess_logs,
                        (
                            f"create {model_cls.__name__}s",
                            {
                                "dbUpdate": {
                                    "dbEntity": model_cls.__name__,
                                    "numEntities": num_models,
                                    "parentEntityIds": [sample_guid],
                                    "updateType": "bulk_create",
                                }
                            },
                        ),
                ...
                self.assertListEqual(
                    list(params["get_models_json"](models)),
                    params["expected_models_json"],
                )

                mismatch_row = {
                    **json.loads(parsed_file_lines[0]),
                    params.get("mismatch_field", "p_value"): "0.05",
                }
    ...
    @mock.patch("seqr.utils.communication_utils.send_html_email")
    @mock.patch("seqr.utils.file_utils.subprocess.Popen")
    def test_load_phenotype_prioritization_data(
        self, mock_subprocess, mock_send_email, mock_random
    ):
        ...
        response = self.client.post(
            url, content_type="application/json", data=json.dumps(request_body)
        )
        self.assertEqual(response.status_code, 400)
        self.assertEqual(
            response.json()["error"],
            "File not found: gs://seqr_data/lirical_data.tsv.gz",
        )
        mock_subprocess.assert_called_with(
            "gsutil ls gs://seqr_data/lirical_data.tsv.gz",
            stdout=-1,
            stderr=-2,
            shell=True,
        )  # nosec
        ...
        self.assertEqual(
            response.json()["error"],
            "Invalid file: missing column(s) project, diseaseId",
        )
        mock_subprocess.assert_called_with(
            "gsutil cat gs://seqr_data/lirical_data.tsv.gz | gunzip -c -q - ",
            stdout=-1,
            stderr=-2,
            shell=True,
        )  # nosec
        ...
        mock_subprocess.reset_mock()
        mock_subprocess.return_value.stdout = self._join_data(
            PHENOTYPE_PRIORITIZATION_HEADER + LIRICAL_NO_PROJECT_DATA
        )
        response = self.client.post(
            url, content_type="application/json", data=json.dumps(request_body)
        )
        self.assertEqual(response.status_code, 400)
        self.assertEqual(
            response.json()["error"], "Both sample ID and project fields are required."
        )
        mock_subprocess.assert_called_with(
            "gsutil cat gs://seqr_data/lirical_data.tsv.gz | gunzip -c -q - ",
            stdout=-1,
        ...
        mock_subprocess.return_value.stdout = self._join_data(
            PHENOTYPE_PRIORITIZATION_HEADER + LIRICAL_DATA + EXOMISER_DATA
        )
        response = self.client.post(
            url, content_type="application/json", data=json.dumps(request_body)
        )
        ...
        self.assertEqual(
            response.json()["error"],
            "Multiple tools found lirical and exomiser. Only one in a file is supported.",
        )

        mock_subprocess.return_value.stdout = self._join_data(
            PHENOTYPE_PRIORITIZATION_HEADER + LIRICAL_PROJECT_NOT_EXIST_DATA
        )
        response = self.client.post(
            url, content_type="application/json", data=json.dumps(request_body)
        )
        ...
        project = Project.objects.create(
            created_by=self.data_manager_user,
        ...
        self.assertEqual(
            response.json()["error"],
            "Project CMG_Beggs_WGS not found. Projects with conflict name(s) 1kg project nåme with uniçøde.",
        )
        project.delete()

        mock_subprocess.return_value.stdout = self._join_data(
            PHENOTYPE_PRIORITIZATION_HEADER + LIRICAL_NO_EXIST_INDV_DATA
        )
        response = self.client.post(
            url, content_type="application/json", data=json.dumps(request_body)
        )
        self.assertEqual(response.status_code, 400)
        self.assertEqual(
            response.json()["error"], "Can't find individuals NA19678x, NA19679x"
        )

        # Test a successful operation
        mock_subprocess.reset_mock()
        mock_subprocess.return_value.stdout = self._join_data(
            PHENOTYPE_PRIORITIZATION_HEADER + LIRICAL_DATA
        )
        self.reset_logs()
        ...
        self._has_expected_file_loading_logs(
            "gs://seqr_data/lirical_data.tsv.gz",
            user=self.data_manager_user,
            additional_logs=[
                (
                    "delete 1 PhenotypePrioritizations",
                    {
                        "dbUpdate": {
                            "dbEntity": "PhenotypePrioritization",
                            "updateType": "bulk_delete",
                ...
                (
                    "create 2 PhenotypePrioritizations",
                    {
                        "dbUpdate": {
                            "dbEntity": "PhenotypePrioritization",
                            "updateType": "bulk_create",
                            "entityIds": [
                                "PP256989491_na19678ensg0000010",
        ...
        saved_data = _get_json_for_models(
            PhenotypePrioritization.objects.filter(tool="lirical").order_by("id"),
            ...
            [
                {
                    "data_type": "Lirical",
                    "user": self.data_manager_user,
                    "email_body": "data for 1 Lirical sample(s)",
                },
                {
                    "data_type": "Lirical",
                    "user": self.data_manager_user,
        ...
        mock_subprocess.return_value.stdout = self._join_data(
            PHENOTYPE_PRIORITIZATION_HEADER + UPDATE_LIRICAL_DATA
        )
                ...
                (
                    "create 2 PhenotypePrioritizations",
                    {
                        "dbUpdate": {
                            ...
                            "updateType": "bulk_create",
                            "entityIds": [
                                "PP177442291_na19678ensg0000010",
                                "PP215071655_na19678ensg0000010",
                            ],
                        }
                    },
                ),
        ...
        saved_data = _get_json_for_models(
            PhenotypePrioritization.objects.filter(tool="lirical"),
            nested_fields=[{"fields": ("individual", "guid"), "key": "individualGuid"}],
        )
    ...
    def _test_expected_vcf_responses(self, response, url):
        ...
        self.mock_glob.return_value = [
            "/local_datasets/sharded_vcf/part001.vcf",
            "/local_datasets/sharded_vcf/part002.vcf",
            "/local_datasets/test.vcf.gz",
        ]
        response = self.client.get(url, content_type="application/json")
        self.assertEqual(response.status_code, 200)
        self.assertDictEqual(
            response.json(), {"vcfs": ["/sharded_vcf/part00*.vcf", "/test.vcf.gz"]}
        )
        self.mock_glob.assert_called_with("/local_datasets/**", recursive=True)
    ...
    def test_validate_callset(self):
        ...
        response = self.client.post(
            url, content_type="application/json", data=json.dumps(self.REQUEST_BODY)
        )
        self.assertEqual(response.status_code, 400)
        self.assertListEqual(
            response.json()["errors"],
            [f"Data file or path {self.CALLSET_DIR}/callset.vcf is not found."],
        )
        ...
        body = {
            **self.REQUEST_BODY,
            "filePath": f"{self.CALLSET_DIR}/sharded_vcf/part0*.vcf",
        }
        response = self.client.post(
            url, content_type="application/json", data=json.dumps(body)
        )
        ...
        self.assertListEqual(
            response.json()["errors"],
            [
                f"Data file or path {self.CALLSET_DIR}/sharded_vcf/part0*.vcf is not found."
            ],
        )
    ...
    @mock.patch(
        "seqr.views.utils.permissions_utils.INTERNAL_NAMESPACES",
        ["my-seqr-billing", "ext-data"],
    )
    @mock.patch(
        "seqr.views.utils.airtable_utils.BASE_URL", "https://seqr.genomics4rd.ca/"
    )
    @responses.activate
    def test_get_loaded_projects(self):
        responses.add(
            responses.GET,
            "https://api.airtable.com/v0/app3Y97xtbbaOopVR/Samples",
        ...
        self.assertDictEqual(
            response.json(),
            {
                "projects": [
                    {
                        **self.PROJECT_OPTION,
                        "dataTypeLastLoaded": "2018-02-05T06:31:55.397Z",
                    }
                ]
            },
        )
    ...
    def test_load_data(self, mock_temp_dir, mock_open, mock_mkdir):
        ...
        self.assertDictEqual(
            response.json(),
            {"error": "The following projects are invalid: R0005_not_project"},
        )
        ...
        self._assert_expected_load_data_requests(
            sample_type="WES", skip_validation=True
        )
        self._has_expected_ped_files(
            mock_open,
            mock_mkdir,
            "SNV_INDEL",
            sample_type="WES",
            has_remap=bool(self.MOCK_AIRTABLE_KEY),
        )

        dag_json = {
            "projects_to_run": ["R0001_1kg", "R0004_non_analyst_project"],
        ...
        body.update(
            {"datasetType": "SV", "filePath": f"{self.CALLSET_DIR}/sv_callset.vcf"}
        )
        ...
        body.update(
            {
                "sampleType": "WGS",
                "projects": [json.dumps(self.PROJECT_OPTION)],
        ...
        self._test_load_single_project(
            mock_open, mock_mkdir, response, url=url, body=body
        )
    ...
    def _has_expected_ped_files(
        ...
        mock_open.assert_has_calls(
            [
                mock.call(
                    f"{self._local_pedigree_path(dataset_type, sample_type)}/{project}_pedigree.tsv",
                    "w",
                )
    ...
    def _test_load_single_project(
        self, mock_open, mock_mkdir, response, *args, **kwargs
    ):
        self.assertEqual(response.status_code, 200)
        self.assertDictEqual(response.json(), {"success": True})
        self._has_expected_ped_files(
            mock_open, mock_mkdir, "SNV_INDEL", single_project=True
        )
    ...
    def _test_no_affected_family(self, url, body):
        ...
        self.assertDictEqual(
            ...
            {
                "errors": [
                    "The following families do not have any affected individuals: 5"
                ],
                "warnings": None,
            },
        )
    ...
    def test_trigger_dag(self):
        ...
        url = self._test_trigger_single_dag(
...
class LocalDataManagerAPITest(AuthenticationTestCase, DataManagerAPITest):
    ...
    WES_PROJECT_OPTIONS = [
        {
            "name": "1kg project nåme with uniçøde",
            "projectGuid": "R0001_1kg",
            "dataTypeLastLoaded": "2017-02-05T06:25:55.397Z",
        },
        EMPTY_PROJECT_OPTION,
    ]
    ...
    def setUp(self):
        ...
        self.mock_file_iter = (
            self.mock_open.return_value.__enter__.return_value.__iter__
        )
        ...
        self.mock_unzipped_file_iter = (
            self.mock_unzipped_open.return_value.__enter__.return_value.__iter__
        )
    ...
    def _assert_expected_load_data_requests(
        self,
        dataset_type="SNV_INDEL",
        sample_type="WGS",
        trigger_error=False,
        ...
        body = {
            ...
            "callset_path": (
                "/local_datasets/sv_callset.vcf"
                if trigger_error
                else "/local_datasets/callset.vcf"
            ),
    ...
    def _has_expected_ped_files(
        self, mock_open, mock_mkdir, dataset_type, *args, sample_type="WGS", **kwargs
    ):
        super()._has_expected_ped_files(
            mock_open, mock_mkdir, dataset_type, *args, sample_type, **kwargs
        )
        mock_mkdir.assert_called_once_with(
            self._local_pedigree_path(dataset_type, sample_type), exist_ok=True
        )

    def _assert_success_notification(self, dag_json):
        self.maxDiff = None
        self.assert_json_logs(
            self.pm_user, [("Triggered loading pipeline", {"detail": dag_json})]
        )
    ...
    def _trigger_error(self, url, body, dag_json, mock_open, mock_mkdir):
        ...
        self.assertDictEqual(
            ...
            {
                "errors": [
                    "The following families have previously loaded samples absent from the vcf\nFamily 2: HG00732, HG00733"
                ],
                "warnings": None,
            },
        )

    def _assert_trigger_error(
        self, response, body, *args, response_body=None, **kwargs
    ):
        self.assertEqual(response.status_code, 400)
    ...
    def _assert_expected_read_vcf_header_subprocess_calls(self, body):
        self.mock_subprocess.assert_has_calls(
            [
                mock.call(
                    f'dd skip=0 count=65537 bs=1 if={self.TRIGGER_CALLSET_DIR}{body["filePath"]} status="none" | gunzip -c - ',
                    stdout=-1,
                    stderr=-2,
                    shell=True,
                )  # nosec
...
class AnvilDataManagerAPITest(AirflowTestCase, DataManagerAPITest):
    ...
    PROJECT_OPTIONS = [
        {
            "projectGuid": "R0001_1kg",
            "sampleIds": ["NA19675_1", "NA19678", "NA19679", "HG00732", "HG00733"],
        },
    ...
    def _add_file_list_iter(self, file_list, stdout):
        formatted_files = "\n".join(
            [f"{self.CALLSET_DIR}/{file}" for file in file_list]
        )
        self.mock_does_file_exist.communicate.return_value = (
            f"{formatted_files}\n".encode("utf-8"),
            b"",
        )
    ...
    def _get_expected_read_file_subprocess_calls(self, file_name, sample_guid):
        ...
        self.mock_subprocess.assert_called_with(
            gsutil_cat, stdout=-1, stderr=-2, shell=True
        )  # nosec
        return [
            (
                f"==> gsutil ls gs://seqr-scratch-temp/{file_name}/{sample_guid}.json.gz",
    ...
    def _assert_expected_delete_index_response(self, response):
        ...
        self.assertEqual(
            response.json()["error"],
            "Deleting indices is disabled for the hail backend",
        )
    ...
    def _assert_expected_get_projects_requests(self):
        ...
        expected_filters = [
            ...
            for additional_filter in [
                ",LEN({SV_CallsetPath})>0",
                ",LEN({MITO_WGS_CallsetPath})>0",
                "",
                "",
            ]
        ]
    ...
    def _assert_expected_pm_access(self, get_response):
        ...
        self.assert_json_logs(
            ...
            [
                (
                    "PermissionDenied: Error: To access RDG airtable user must login with Broad email.",
                    {"severity": "WARNING"},
                )
            ],
        )
    ...
    def _assert_expected_load_data_requests(self, dataset_type="SNV_INDEL", **kwargs):
        ...
        if not is_gcnv:
            self._assert_expected_airtable_vcf_id_call(
                required_sample_field, call_index=1
            )
        self.ADDITIONAL_REQUEST_COUNT = 1 if is_gcnv else 2
        self.assert_airflow_loading_calls(
            offset=self.ADDITIONAL_REQUEST_COUNT, dataset_type=dataset_type, **kwargs
        )

    def _assert_expected_airtable_call(
        self,
        required_sample_field,
        project_guid,
        call_index=0,
        additional_filter=None,
        additional_pdo_statuses="",
        additional_fields=None,
    ):
        airtable_filters = [
            f"SEARCH('https://seqr.genomics4rd.ca/project/{project_guid}/project_page',ARRAYJOIN({{SeqrProject}},';'))",
    ...
    def _assert_expected_airtable_vcf_id_call(
        self, required_sample_field=None, additional_vcf_ids="", **kwargs
    ):
        self._assert_expected_airtable_call(
            required_sample_field,
            "R0004_non_analyst_project",
            **kwargs,
            additional_fields=["VCFIDWithMismatch"],
    ...
    def _assert_trigger_error(self, response, body, dag_json, **kwargs):
        ...
        self.mock_airflow_logger.error.assert_called_with(
            mock.ANY, self.data_manager_user
        )
        errors = [
            call.args[0] for call in self.mock_airflow_logger.error.call_args_list
        ]
        for error in errors:
        ...
        dag_json = (
            json.dumps(dag_json, indent=4)
            .replace("callset.vcf", "sv_callset.vcf")
            .replace("WGS", "WES")
            .replace("SNV_INDEL", "GCNV")
            .replace("v01", "v3.1")
        )
        ...
        """
        self.mock_slack.assert_called_once_with(
            SEQR_SLACK_LOADING_NOTIFICATION_CHANNEL, error_message
        )
    ...
    def _trigger_error(self, url, body, dag_json, mock_open, mock_mkdir):
        ...
        body["projects"] = [
            json.dumps(
                {
                    **PROJECT_OPTION,
                    "sampleIds": PROJECT_SAMPLES_OPTION["sampleIds"] + ["NA21988"],
                }
            )
        ]
        response = self.client.post(
        ...
        body["projects"] = [
            json.dumps(
                {
                    **PROJECT_OPTION,
                    "sampleIds": [PROJECT_SAMPLES_OPTION["sampleIds"][1]],
                }
            )
        ]
        body["sampleType"] = "WGS"
        self.assertEqual(len(responses.calls), 1)
        self._assert_expected_airtable_vcf_id_call(
            required_sample_field="gCNV_CallsetPath",
            additional_vcf_ids=",VCFIDWithMismatch='NA21987'",
        )
        ...
        self.assertEqual(len(responses.calls), 2)
        self._assert_expected_airtable_call(
            required_sample_field="SV_CallsetPath",
            project_guid="R0004_non_analyst_project",
        )
        self.mock_authorized_session.reset_mock()

    def _test_load_single_project(
        self, mock_open, mock_mkdir, response, *args, url=None, body=None, **kwargs
    ):
        super()._test_load_single_project(mock_open, mock_mkdir, response, url, body)
        self.ADDITIONAL_REQUEST_COUNT = 0
        self.assert_airflow_loading_calls(
            offset=0, dataset_type="SNV_INDEL", trigger_error=True
        )
        ...
        self.assertDictEqual(response.json(), {"success": True})
        self._has_expected_ped_files(
            mock_open, mock_mkdir, "SNV_INDEL", sample_type="WES"
        )
        self.assertEqual(len(responses.calls), 2)
        self.assert_expected_airtable_call(
            call_index=0,
            filter_formula="AND(SEARCH('https://seqr.genomics4rd.ca/project/R0001_1kg/project_page',ARRAYJOIN({SeqrProject},';')),LEN({PassingCollaboratorSampleIDs})>0,OR(SEARCH('Available in seqr',ARRAYJOIN(PDOStatus,';')),SEARCH('Historic',ARRAYJOIN(PDOStatus,';'))))",
            fields=[
                "CollaboratorSampleID",
                "SeqrCollaboratorSampleID",
                "PDOStatus",
    ...
    def _has_expected_ped_files(
        ...
        super()._has_expected_ped_files(
            mock_open, mock_mkdir, dataset_type, sample_type, **kwargs
        )
    ...
    def _test_validate_dataset_type(self, url):
        body = {
            "filePath": f"{self.CALLSET_DIR}/mito_callset.mt",
            "datasetType": "MITO",
        ...
        self.assertListEqual(
            response.json()["errors"],
            [f"Data file or path {self.CALLSET_DIR}/mito_callset.mt is not found."],
        )
        ...
        self.assertEqual(response.status_code, 400)
        self.assertListEqual(
            response.json()["errors"], ["Missing required FORMAT field(s) GQ, GT"]
        )
    ...
    def _assert_update_check_airflow_calls(self, call_count, offset, update_check_path):
        ...
        super()._assert_update_check_airflow_calls(
            call_count, offset, update_check_path
        )
    ...
    def _assert_expected_dag_trigger(self, response, dag_id, variables):
        ...
        self.assertDictEqual(
            ...
            {
                "info": [
                    f"Triggered DAG {dag_id} with variables: {json.dumps(variables)}"
                ]
            },
        )
    ...
    def _test_dag_trigger_errors(self, url, body):
        ...
        self.assertDictEqual(
            response.json(),
            {
                "error": "UPDATE_REFERENCE_DATASETS DAG is running and cannot be triggered again."
            },
        )
    ...
    def _assert_expected_airtable_errors(self, url):
        responses.replace(
            responses.GET,
            "https://api.airtable.com/v0/app3Y97xtbbaOopVR/Samples",
            json=INVALID_AIRTABLE_SAMPLE_RECORDS,
            status=200,
        )
        response = self.client.get(url)
        self.assertEqual(response.status_code, 400)
