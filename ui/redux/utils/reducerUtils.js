...
export const REQUEST_EXPRESSION_DATA = 'REQUEST_EXPRESSION_DATA'
export const RECEIVE_EXPRESSION_DATA = 'RECEIVE_EXPRESSION_DATA'
export const REQUEST_SPLICE_DATA = 'REQUEST_SPLICE_DATA'
export const RECEIVE_SPLICE_DATA = 'RECEIVE_SPLICE_DATA'
